...
class Banner extends Component {
  render() {
    return (
      <section
        id="home_section"
        className="section_banner small_pb bg_black_dark"
        data-z-index={1}
        data-parallax="scroll"
        data-image-src={require("../images/banner_img2.png")}
      >
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12 col-sm-12 order-lg-first">
              <div className="banner_text text_md_center">
                ...
                >
                  The mining starts immediately after confirmed payment. First
                ...
                <div id="whitepaper" className="team_pop mfp-hide">
                  <div className="row m-0">
                    ...
                    <div className="col-md-5">
                      <img
                        className="pt-3 pb-3"
                        src={require("../images/whitepaper.png")}
                        alt="whitepaper"
                      />
                    </div>
                  </div>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 order-first">
              ...
              >
                <img
                  alt="banner_vector2"
                  src={require("../images/banner_img2.png")}
                />
              </div>
            </div>
          </div>
